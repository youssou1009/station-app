...
<form role="form" wire:submit.prevent='updateStation()'>
<div class="card-body">
<div class="form-group">
<label>Nom</label>
<input type="text" wire:model='editStation.nom' class="form-control @error('editStation.nom')
    is-invalid
@enderror">
@error('editStation.nom')
...
<div class="row">
  ...
  <div class="col-4">
    ...
    <input type="number" wire:model='editStation.latitude' class="form-control @error('editStation.latitude')
        is-invalid
    @enderror">
    @error('editStation.latitude')
        <span class="text-danger">{{ $message }}</span>
    @enderror
    </div>
  </div>
  ...
  <div class="col-4">
    ...
    <input type="number" wire:model='editStation.longitude' class="form-control @error('editStation.longitude')
        is-invalid
    @enderror">
    @error('editStation.longitude')
        <span class="text-danger">{{ $message }}</span>
    @enderror
    </div>
  </div>
  ...
  <div class="col-4">
    <div class="form-group">
    <label>Atitude</label>
    <input type="number" wire:model='editStation.altitude' class="form-control @error('editStation.altitude')
        is-invalid
    @enderror">
    @error('editStation.altitude')
        <span class="text-danger">{{ $message }}</span>
    @enderror
    </div>
  </div>
...
<button type="submit" class="btn btn-primary">Appliqur les modifications</button>
